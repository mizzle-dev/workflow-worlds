 ...
 * - WORKFLOW_DEBUG=turso - enables only turso namespace
 * - WORKFLOW_DEBUG=redis,turso - enables multiple namespaces
 *
...
/**
 * Debug logger for turso-world.
 * Enable with WORKFLOW_DEBUG=turso or WORKFLOW_DEBUG=1
 */
export const debug = createDebugLogger('turso-world');
